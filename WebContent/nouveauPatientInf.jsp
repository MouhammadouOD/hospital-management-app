...
<body>
	...
	<!-- PAGE INSCRIPTION---------------------------------------- -->
  					...
  					<div class="container">
						...
						<form method="post" action="nouveauPatientI" class="was-validated">
 							...
 							<div class="form-group">
  							...
  							<div class="form-group">
    							...
    							<input type="datetime-local" class="form-control" id="dateNaissPatient" name="dateNaissPatient" required>
    							<div class="valid-feedback">Valid.</div>
    							<div class="invalid-feedback">Please fill out this field.</div>
  							</div>
