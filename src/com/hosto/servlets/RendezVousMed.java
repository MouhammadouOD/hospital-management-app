...
/**
 * Servlet implementation class RendezVousMed
 */
@WebServlet(urlPatterns ="/rendezVousMed", loadOnStartup=1)
public class RendezVousMed extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher( "/rendezVousMed.jsp" ).forward( request, response );
