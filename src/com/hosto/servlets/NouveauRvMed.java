...
@WebServlet(urlPatterns ="/nouveauRvMed",loadOnStartup=1)

public class NouveauRvMed extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher( "/nouveauRvMed.jsp" ).forward( request, response );
	}
