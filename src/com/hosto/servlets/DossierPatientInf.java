 ...
 */
@WebServlet( urlPatterns ="/dossierPatientInf", loadOnStartup=1)
public class DossierPatientInf extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher( "/dossierPatientInf.jsp" ).forward( request, response );
