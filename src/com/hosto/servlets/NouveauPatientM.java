 ...
 */
@WebServlet(urlPatterns ="/nouveauPatientM",loadOnStartup=1)
public class NouveauPatientM extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher( "/nouveauPatientMed.jsp" ).forward( request, response );
